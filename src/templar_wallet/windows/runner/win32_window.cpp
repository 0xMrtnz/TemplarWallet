...
/// Minimum logical window size so screens never overflow their layout
/// (mirrors the minimum in linux/runner/my_application.cc).
...
Win32Window::MessageHandler(HWND hwnd,
  ...
  switch (message) {
    ...
    case WM_GETMINMAXINFO: {
      // Enforce the minimum window size, scaled to the monitor's DPI like
